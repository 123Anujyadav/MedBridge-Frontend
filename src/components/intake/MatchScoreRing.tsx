...
export const MatchScoreRing: React.FC<MatchScoreRingProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center shrink-0 space-y-4">
      ...
      <span className="inline-flex min-h-8 max-w-full items-center gap-2 whitespace-nowrap rounded-full border border-primary/20 bg-primary/10 px-4 py-1 text-[11px] font-bold text-primary">
